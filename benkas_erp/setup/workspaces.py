...
def _charts():
    return [
        ...
        ("delay_reasons", "Benkas Task Status", "Daily Task Progress", "status", "Donut", [],
         "Daily Progress Log"),
    ...
    return [
        ...
        {"name": "Work Schedule and Progress", "icon": "calendar",
         ...
         "shortcuts": [("Page", "Section 360°", "section-360", "compass"),
                       ...
                       ("Report", "Weekly Section Report", "Weekly Section Report"),
                       ("Report", "Stoppage Analysis", "Stoppage Analysis"),
