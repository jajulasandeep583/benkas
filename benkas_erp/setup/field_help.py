...
FIELD_HELP = {
    ...
    "Daily Progress Log": {
        ...
        "photos": "Attach at least one site photo showing today's work (required).",
        "remarks": "Anything worth noting about the day.",
    },
    "Daily Task Progress": {
        "task": "The specific sub-task worked on today (only tasks under this section are valid).",
        "percent_complete": "How complete this task is now, as a percentage.",
        "activity_description": "In one line, what was actually done today.",
        "delay_reason": "Only if this task fell behind plan — pick why.",
    },
    "Daily Worker Log": {
