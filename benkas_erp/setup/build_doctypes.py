...
def doctypes():
    return [
        ...
        {
            "name": "Daily Progress Log", "module": "Work Schedule",
            "autoname": "DPL-.YYYY.-.#####",
            "fields": [
                F("task", "Task", "Link", options="Task", reqd=1, in_list_view=1),
                F("plant_section", "Plant Section", "Link", options="Plant Section", reqd=1, in_list_view=1),
                F("log_date", "Log Date", "Date", default="Today", reqd=1, in_list_view=1),
                F("percent_complete", "Percent Complete", "Percent", in_list_view=1),
                CB("cb1"),
                F("manpower_deployed", "Manpower Deployed", "Int", read_only=1),
                F("material_consumed_value", "Material Consumed Value", "Currency", read_only=1),
                F("delay_reason", "Delay Reason", "Link", options="Delay Reason"),
                SB("sb_desc", "Activity"),
                F("activity_description", "Activity Description", "Small Text"),
